...
Begin WebPage WebPage1
   ...
   Begin WebLabel DescriptionLabel
      ...
      TabIndex        =   0
      TabStop         =   True
      Text            =   "Chips control with random fruits. Use the buttons to add or remove items randomly, or toggle enabled state."
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   20
...
#tag Events ToggleEnabledButton
	#tag Event
		Sub Pressed()
		  ...
		  Chips1.UpdateControl
		  If Chips1.Enabled Then
		    ToggleEnabledButton.Caption = "Disable Chips"
		  Else
		    ToggleEnabledButton.Caption = "Enable Chips"
		  End If
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events AddRandomButton
	#tag Event
		Sub Pressed()
		  ...
		  Var current() As String = Chips1.AllItems
		  ...
		  If available.Count > 0 Then
		    ...
		    Chips1.AddItem(available(idx), Rnd > 0.5)
		    StatePreviewTextArea.Text = Chips1.StateJSON
		  End If
		End Sub
	#tag EndEvent
...
#tag Events RemoveRandomButton
	#tag Event
		Sub Pressed()
		  Var items() As String = Chips1.AllItems
		  If items.Count > 0 Then
		    Var idx As Integer = Floor(Rnd * items.Count)
		    Chips1.RemoveItem(items(idx))
		    StatePreviewTextArea.Text = Chips1.StateJSON
		  End If
		End Sub
	#tag EndEvent
